...
const CONNECTORS: Connector[] = [
  ...
  // Phase 13: External Service Connectors
  {
    id: "linear",
    name: "Linear",
    descKey: "connectors.linearDesc",
    color: "#5E6AD2",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/>
        <path d="M8 12h8v2H8z" opacity="0.5"/>
        <path d="M8 9h5v6H8z"/>
      </svg>
    ),
    connected: false,
    onConnect: () => window.open(`${import.meta.env.VITE_API_BASE_URL || "http://localhost:3000"}/api/infinity/connectors/linear/oauth/start?projectId=demo`, "_blank"),
    onDisconnect: () => console.log("Disconnect Linear"),
  },
  {
    id: "notion",
    name: "Notion",
    descKey: "connectors.notionDesc",
    color: "#000000",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M20.5 3.5H3.5C2.7 3.5 2 4.2 2 5v14c0 .8.7 1.5 1.5 1.5H20.5c.8 0 1.5-.7 1.5-1.5V5c0-.8-.7-1.5-1.5-1.5zM18.5 17H5.5V7h13v10zM12 13H9v-2h3v2zm0-4H9V5h3v4z"/>
      </svg>
    ),
    connected: false,
    onConnect: () => window.open(`${import.meta.env.VITE_API_BASE_URL || "http://localhost:3000"}/api/infinity/connectors/notion/oauth/start?projectId=demo`, "_blank"),
    onDisconnect: () => console.log("Disconnect Notion"),
  },
  {
    id: "google-sheets",
    name: "Google Sheets",
    descKey: "connectors.googleSheetsDesc",
    color: "#34A853",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M6 3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H6zm10 16H6V5h10v14zm-6-8h4v4h-4zm0 6h4v4h-4z"/>
      </svg>
    ),
    connected: false,
    onConnect: () => window.open(`${import.meta.env.VITE_API_BASE_URL || "http://localhost:3000"}/api/infinity/connectors/google-sheets/oauth/start?projectId=demo`, "_blank"),
    onDisconnect: () => console.log("Disconnect Google Sheets"),
  },
];
