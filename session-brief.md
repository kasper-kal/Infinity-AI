...
4. **READY TO START — PHASE C: The Loop Is One Mind (R1)** — per PHASES.md: kill phase machine, growing conversation, native tool_calls, done tool, quality-gate stop, verify-after-edit, real state return, tool-based coder. Requires user "go" to begin (CLAUDE.md autonomous execution).
