...
- **Phase 36: Visual Build Map — MARKED COMPLETE ✅** (all remaining ~10% items already implemented):
  ...
  - **Dynamic Island integration**: Build tasks navigate to `tab: "buildMap"` (LiveTaskDisplayItem.tsx:76)
  - **BuildView enhancements**: `initialTab` prop supports `'buildMap' | 'advancedAgent'` for direct linking
